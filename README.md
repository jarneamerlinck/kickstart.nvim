...
3. If you are using kickstart.nixvim with your own flake then update your flake.nix to refer to your local kickstart.nixvim repo

    ```nix
    inputs.kickstart-nixvim.url = "path:<PATH_TO>/kickstart.nixvim";
    ```

4. Or if you are running kickstart.nixvim standalone run in your cloned repo directory
...
5. If you are using kickstart.nixvim with your own flake confirm the `init.lua` file has been created and loads without errors
